...
  
  ...
  // FUNGSI LOGIN DITAMBAHKAN DI SINI
  const handleLogin = async (e) => {
    ...
    try {
      // 1. Minta CSRF cookie dari Laravel
      // await api.get('/sanctum/csrf-cookie');
      
      // 2. Kirim data login ke endpoint /api/login
...
  // Cek apakah form sudah terisi untuk mengaktifkan tombol
  useEffect(() => {
    if (nik && password) {
      setIsActive(true);
    } else {
